        ...
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          ...
          >
            ...
            <div className="space-y-6 text-lg text-foreground/80 leading-relaxed font-medium">
              ...
              <p>
                ColorStack UTD is home to 60+ members and growing. Every workshop, every event, and every connection we make is one more step toward closing the gap in tech.
              </p>
            </div>
          </motion.div>
